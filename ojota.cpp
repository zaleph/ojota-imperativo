...
Atleta atletaProdigio(const JJOO & j) {
    ...
    while (i<j.competenciasFinalizadasConOroEnPodio().longitud()){
        ...
        // I: 1 <= i <= |competenciasConOroEnPodio(j)| && esCampeon(a,j) && (∀c ∈ competenciasConOroEnPodio(j)[0..i)) añoNacimiento(a) >= añoNacimiento(campeon(c));
		...
		// implica 1 <= i <= |competenciasConOroEnPodio(j)| && esCampeon(a,j) && ((∀c ∈ competenciasConOroEnPodio(j)[0..i)) añoNacimiento(a) >= añoNacimiento(campeon(c))) && (|competenciasConOroEnPodio(j)| - i <= 0);
    ...
    // Quiero Ver: (I && ¬B) -> Qc.
	// vale I && ¬B
	// implica 1 <= i <= |competenciasConOroEnPodio(j)| && esCampeon(a,j) && ((∀c ∈ competenciasConOroEnPodio(j)[0..i)) añoNacimiento(a) >= añoNacimiento(campeon(c))) && ¬(i < |competenciasConOroEnPodio(j)|)
	// implica i >= |competenciasConOroEnPodio(j)|
	// implica i == |competenciasConOroEnPodio(j)|
